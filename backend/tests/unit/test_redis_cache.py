...
class TestInsightsAIActionsCache:
    """Cache-first behavior of /organizations/{org}/insights AI actions."""

    ORG = "22222222-2222-2222-2222-222222222222"
    CANNED_ACTIONS = [{"title": "Cached action", "severity": "info"}]
    ...
    def _patched_call(self, cache_hit):
        ...
        patches = [
            ...
            patch.object(
                ...
                return_value=self.CANNED_ACTIONS if cache_hit else None,
            ),
        ]
    ...
    def test_cache_hit_skips_llm_call(self):
        ...
        assert result["aiActions"] == self.CANNED_ACTIONS
        gen.assert_not_called()

    def test_cache_miss_generates_and_sets(self):
        from app.modules.dashboard.routes import insights as insights_route
        ...
        assert key == f"ai:actions:{self.ORG}:30d"
