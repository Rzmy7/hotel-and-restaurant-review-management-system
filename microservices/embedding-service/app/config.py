...
DEFAULT_THRESHOLDS = {"oneWord": 1.3, "twoWords": 1.2, "threeOrMore": 1.1}


def load_full_config() -> Dict:
    """Load full configuration from file"""
    if not CONFIG_FILE.exists():
        default_config = {"thresholds": DEFAULT_THRESHOLDS, "isPaused": False}
    ...
    try:
        ...
        return {"thresholds": DEFAULT_THRESHOLDS, "isPaused": False}
