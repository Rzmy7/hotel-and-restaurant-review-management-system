"""
TripAdvisor Scrape Endpoint
===========================
POST /api/tripadvisor/scrape — triggers playwright scraper via the thread pool.
...
# ── Request Schema ──
class TripAdvisorScrapeRequest(BaseModel):
    """Payload for triggering a TripAdvisor scrape job."""
    source_id: str
    source_url: str
