...
class GoogleSelectors(BaseModel):
    ...
    # Rating & Date
    review_rating: str = ".fzvQIb"  # aria-label contains "X/5" or star count
    review_date: str = ".xRkPPb"   # e.g. "2 months ago"
    
    # Review text
    review_text: str = ".wiI7pd"
    expand_review_btn: str = ".w8nwRe.kyuRq"  # "More" button to expand truncated reviews
    
    # Owner/Property reply
    reply_container: str = ".CDe7pd"
    reply_text: str = ".CDe7pd .wiI7pd"
    
    # Photos attached to reviews
    review_photos: str = ".Tya61d"
    
    # Scrollable container for infinite scroll pagination
    scroll_container: str = ".m6QErb.DxyBCb.kA9KIf.dS8AEf.XiKgde"
