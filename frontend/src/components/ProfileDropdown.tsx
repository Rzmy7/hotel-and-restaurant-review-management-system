...
import { User, Settings, HelpCircle, LogOut, Shield, ChevronRight } from 'lucide-react';
            ...
            <div className="px-5 py-4 border-b border-gray-100">
                <div className="flex items-center gap-3">
                    ...
                    <div className="min-w-0">
                        <p className="text-sm font-semibold text-gray-900 m-0 truncate">Liam Anderson</p>
                        <p className="text-xs text-gray-400 m-0 mt-0.5 truncate">liam@grandplazahotel.com</p>
                    </div>
                </div>
                ...
                {menuItems.map((item, idx) => (
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            <p className="text-[11px] text-gray-400 m-0 mt-0.5">{item.subtitle}</p>
                        </div>
