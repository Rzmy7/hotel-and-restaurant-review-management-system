...
const ReviewDetailModal = ({ isOpen, onClose, review }: ReviewDetailModalProps) => {
  ...
  const customHeader = (
    <div className="flex items-center justify-between px-8 py-6 border-b border-gray-100 bg-white/80 sticky top-0 z-10 backdrop-blur-md w-full">
    ...
    <>
      ...
      >
        <div className="flex flex-col w-full h-full">
          ...
          {/* Scrollable Content */}
          <div className="flex-1 overflow-y-auto overflow-x-hidden bg-gray-50/30 w-full">
