            ...
            {Object.entries(groupedChanges).map(([tab, tabChanges]) => (
              <div key={tab}>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-[11px] font-black tracking-widest text-[#4e80ee] dark:text-blue-400 uppercase">
                    {tab}
                  </h3>
                  <div className="h-px bg-gray-100 dark:bg-slate-700/50 flex-1" />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {tabChanges.map((change, idx) => (
                    <div
                      key={idx}
                      className="bg-white dark:bg-slate-800 rounded-2xl p-4 border border-gray-100 dark:border-slate-700 shadow-sm flex flex-col gap-3 group hover:border-blue-100 dark:hover:border-blue-900/50 transition-colors"
                    >
                      ...
                      <div className="flex items-center gap-2 text-[12px]">
                        <div
                          className="flex-1 bg-gray-50 dark:bg-slate-900/50 px-3 py-2 rounded-xl text-gray-400 dark:text-slate-500 font-medium line-through decoration-rose-400/30 truncate"
                        ...
                        <div
                          className="flex-1 bg-blue-50/50 dark:bg-blue-900/20 px-3 py-2 rounded-xl text-blue-600 dark:text-blue-400 font-bold truncate border border-blue-50 dark:border-blue-900/30"
