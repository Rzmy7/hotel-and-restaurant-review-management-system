    ...
    return (
        <>
            <div className="flex flex-col gap-5">
                ...
                {/* Account Password */}
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 rounded-2xl border border-gray-100 dark:border-slate-700/50 bg-gray-50/40 dark:bg-slate-800/40">
                ...
                <div className="p-6 space-y-4">
                    ...
                    <FormField label="New Password">
                        ...
                        <div className="mt-3 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800/70 p-3 space-y-2">
                            ...
                            <RequirementRow isValid={passwordChecks.uppercase} label="Includes uppercase letter" />
                            <RequirementRow isValid={passwordChecks.number} label="Includes number" />
                            <RequirementRow isValid={passwordChecks.symbol} label="Includes symbol" />
                        </div>
                    </FormField>
