...
export const HotelInfoSettingsCard: React.FC<HotelInfoSettingsCardProps> = ({
  ...
  const rulesFilename =
    organizationRules.length > 0 ? organizationRules[0]?.source_filename : null;
        ...
        <div className="flex gap-6 items-start max-md:flex-col">
          ...
          >
            {data.logoUrl ? (
              ...
              <>
                <Upload
                  className="text-gray-400 group-hover:text-[#4e80ee] transition-colors"
                  size={32}
                />
          ...
          <div className="flex flex-col gap-3 pt-2">
            ...
            <Button
              ...
              disabled={isUploadingLogo || !data.logoUrl}
            >
              Remove
            </Button>
          ...
          <div className="flex flex-col gap-4">
            <div>
              ...
              <p className="text-xs text-slate-400 dark:text-slate-500 mb-4">
                Upload a document containing your property's rules and
                regulations. The AI will extract individual rules and use them
                when generating review replies.
              </p>
            </div>
            ...
            <div className="flex items-start gap-4 max-md:flex-col">
              ...
              <div className="flex flex-col gap-2 pt-1 min-w-[130px]">
                ...
                {rulesFilename && (
                  <p
                    className="text-[10px] text-slate-400 dark:text-slate-500 font-medium truncate max-w-[130px]"
                    title={rulesFilename}
                  >
                    📄 {rulesFilename}
                  </p>
                  ...
                  {organizationRules.map((rule) => (
                    ...
                    >
                      ...
                      <span
                        ...
                        title={
                          rule.is_embedded ? "Embedded" : "Pending embedding"
                        }
                      >
                        {rule.is_embedded ? (
                          <CheckCircle2
