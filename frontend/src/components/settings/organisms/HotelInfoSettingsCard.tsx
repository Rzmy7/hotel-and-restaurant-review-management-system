...
import { HotelInfoSettings } from '../../../types/settings';
    ...
    return (
        <Card className="p-6 md:p-8">
            ...
            <div className="flex flex-col">
                ...
                {/* Logo Upload */}
                <div className="flex flex-col gap-2 py-6 border-b border-gray-100 last:border-b-0">
                    <div className="flex gap-6 items-start max-md:flex-col">
                        <div
                            onClick={onLogoUpload}
                            className="w-[140px] h-[140px] border-2 border-dashed border-gray-200 rounded-2xl flex flex-col items-center justify-center gap-2 cursor-pointer transition-all bg-gray-50/50 hover:border-blue-400 hover:bg-blue-50/50 group max-md:w-full max-md:max-w-[200px]"
                        >
                        ...
                        <div className="flex flex-col gap-3 pt-2">
                            <Button variant="outline" size="sm" onClick={onLogoUpload}>Change Logo</Button>
                            <Button variant="danger" size="sm" onClick={onLogoRemove}>Remove</Button>
                ...
                <div className="grid grid-cols-2 gap-6 py-6 border-b border-gray-100 max-md:grid-cols-1">
