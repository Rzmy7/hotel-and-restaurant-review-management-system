      ...
      try {
        ...
        const nextFeatureUsage = (usage.features || []).map((feature) => {
          ...
          const balance =
            feature.limit === null
              ? null
              : Math.max(feature.limit - organizationsCount, 0);
          return {
            ...feature,
  ...
  const selectedPlan = useMemo(() => {
    ...
    return (
      plans.find((plan) => {
        ...
        return (
          idKey === aliasedPlanKey ||
          nameKey === aliasedPlanKey ||
          nameKey === planKey
        );
      }) ?? null
    );
        ...
        <div className="border border-gray-200 dark:border-slate-700 rounded-xl overflow-hidden max-w-[680px]">
          ...
          {usageLoading ? (
            ...
            featureUsage.map((feature) => (
              ...
              >
                <div className="col-span-5 font-medium text-gray-800 dark:text-slate-100">
                  {feature.name}
                </div>
      ...
      <FormField label="Payment Method">
        <div className="flex items-center justify-between p-3.5 px-4 border border-gray-200 dark:border-slate-700 bg-gray-50/50 dark:bg-slate-800/50 rounded-xl max-w-[400px]">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <div className="text-[13px] font-black tracking-tight text-gray-700 dark:text-gray-200">
                Visa ****1234
              </div>
          ...
          <Button
            ...
            className="text-[#4e80ee] active:scale-95"
          >
            Edit
          </Button>
        </div>
