...
export const SettingsTemplate: React.FC<SettingsTemplateProps> = ({
    ...
    return (
        <div className="min-h-full bg-gray-50 dark:bg-slate-900 flex flex-col relative pb-24 transition-colors duration-300">
            ...
            {/* Main Content Area */}
            <main className="flex-1 w-full max-w-[1600px] mx-auto px-4 md:px-8 py-6 overflow-y-auto">
                {children}
            </main>

            {/* Sticky Action Footer */}
            <div
                className="fixed bottom-0 right-0 left-0 z-50 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-t border-gray-200 dark:border-slate-800 px-8 py-4 flex gap-4 justify-end shadow-[0_-4px_24px_rgba(0,0,0,0.02)] dark:shadow-none transition-all duration-300"
