...
const ProfileForm: React.FC<ProfileFormProps> = ({ profile, onSave, saving }) => {
    ...
    const inputClasses = "border border-gray-300 rounded p-2 w-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all";
