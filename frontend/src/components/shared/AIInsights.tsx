    ...
    <div className="bg-white border border-gray-100 rounded-xl p-6 flex flex-col h-full shadow-sm hover:shadow-md transition-all duration-300 relative overflow-hidden group">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 flex-1">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-2 px-1">
            ...
            <h4 className="m-0 text-[10px] font-black text-gray-400 uppercase tracking-widest">
              Key Strengths
            </h4>
          </div>
          <div className="space-y-2.5">
            {strengths.map((item) => (
              <div
                key={item.label}
                className="p-3.5 bg-blue-50/20 border border-blue-100/30 rounded-xl hover:bg-blue-50/40 transition-colors group/item"
              >
                ...
                <div className="flex items-center gap-3">
                  <span className="text-[9px] font-black px-1.5 py-0.5 bg-blue-100 text-[#4e80ee] rounded uppercase tracking-widest">
                    Impact: {item.impact}
                  </span>
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2.5">
            {issues.map((item) => (
              <div
                key={item.label}
                className="p-3.5 bg-rose-50/20 border border-rose-100/30 rounded-xl hover:bg-rose-50/40 transition-colors group/item"
              >
                <div className="flex items-center justify-between mb-1.5">
                  <span className="text-[13px] font-black text-gray-800">
                    {item.label}
      ...
      <div className="p-5 bg-blue-50/40 border border-blue-100/60 rounded-2xl relative overflow-hidden group/highlight shadow-sm">
        ...
        <div className="flex items-center gap-3 mb-3 relative z-10">
          ...
          <span className="text-[10px] font-black text-blue-600/80 uppercase tracking-[0.2em] italic">
            AI Highlight
          </span>
        </div>
