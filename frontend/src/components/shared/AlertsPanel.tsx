...
const AlertsPanel = ({ alerts }: AlertsPanelProps) => {
  ...
  return (
    <div
      className="bg-white border border-gray-100 rounded-xl p-6 flex flex-col shadow-sm hover:shadow-md transition-all duration-300"
      style={{ maxHeight: 340 }}
    >
      ...
      <div
        className="flex-1 overflow-y-auto pr-2 space-y-3 -mr-2 scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-transparent"
        style={{ maxHeight: 220 }}
      >
        {alerts.map((alert) => (
          <div
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="m-0 mt-1.5 text-[9px] font-black opacity-50 uppercase tracking-widest">
                {alert.time}
              </p>
            </div>
          </div>
