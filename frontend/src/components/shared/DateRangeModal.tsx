...
const DateRangeModal = ({
  ...
  const [selectedQuickRange, setSelectedQuickRange] = useState<
    "today" | "week" | "month" | "quarter" | "year" | null
  >(null);
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label
                  htmlFor="dateFrom"
                  className="block text-[11px] font-black text-gray-500 dark:text-slate-400 uppercase tracking-widest mb-2"
                >
                  From Date
                </label>
                <input
            ...
            {dateFrom && dateTo && (
              <div className="p-3 bg-blue-50 dark:bg-blue-900/40 border border-blue-200 dark:border-blue-800 rounded-lg">
                <p className="text-xs font-bold text-blue-900 dark:text-blue-300">
                  Selected Range: <span className="font-black">{dateFrom}</span>{" "}
                  to <span className="font-black">{dateTo}</span>
                </p>
              </div>
            )}
          </div>
