...
const ReviewRatingDistribution: React.FC<ReviewRatingDistributionProps> = ({
  ...
  return (
    <>
      <div className="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-800 rounded-xl p-6 flex flex-col shadow-sm hover:shadow-md transition-all duration-300 relative group/card">
        <div className="flex justify-between items-center mb-6 shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 flex items-center justify-center bg-slate-50 dark:bg-slate-900/50 rounded-xl text-[#5988EF] dark:text-blue-400 border border-slate-100/50 dark:border-slate-700/50">
              <BarChart2 size={18} />
            </div>
            <div>
          ...
          <button
            ...
            className="text-[11px] font-black text-[#5988EF] dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 uppercase tracking-widest bg-[#5988EF]/5 dark:bg-blue-900/30 hover:bg-[#5988EF]/10 dark:hover:bg-blue-900/40 px-3 py-1.5 rounded-lg transition-colors flex items-center gap-1"
          >
            See Details
          </button>
        </div>
          ...
          {fullStats.map(({ rating, count, percentage }) => (
            ...
            >
              ...
              <div className="flex-1 h-2.5 bg-gray-100 dark:bg-slate-700 rounded-full overflow-hidden relative">
                <div
                  className="h-full rounded-full transition-all duration-700 ease-out bg-[#5988EF] dark:bg-blue-500 group-hover:opacity-90"
