      ...
      {cards.map((card, index) => (
        ...
        >
          <div className="flex justify-between items-center mb-4">
            ...
            {index === 3 && !isLoading && (
              <div
                className={`flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold ${sentimentStyle.bg} ${sentimentStyle.color} border border-transparent`}
              >
                {stats.sentimentScore >= 70
                  ? "Excellent"
