...
const ReviewDetailLightbox = ({ review, selectedPhotoIndex, onClose, onNavigate }: ReviewDetailLightboxProps) => {
            ...
            {review.photos!.length > 1 && (
                <>
                    ...
                    <button
                        ...
                        onClick={(e) => {
                            e.stopPropagation();
                            if (selectedPhotoIndex < review.photos!.length - 1) onNavigate(selectedPhotoIndex + 1);
                        }}
