                ...
                <div className="flex flex-col border-b border-gray-100 dark:border-slate-700 bg-white/80 dark:bg-slate-800/80 sticky top-0 z-10 backdrop-blur-md shrink-0">
                    <div className="flex items-center justify-between px-6 py-5">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-[17px] font-black text-gray-900 dark:text-white tracking-tight">Review Distribution</h2>
                            </div>
                        </div>
                        <button
                            onClick={onClose}
                ...
                <div className="flex-1 overflow-y-auto p-6 bg-gray-50/40 dark:bg-slate-800/40">
                    {!activeData ? (
                        <div className="text-center py-10 flex flex-col items-center justify-center">
                            ...
                            <h3 className="text-[14px] font-bold text-gray-700 dark:text-gray-300 mb-1">No Data Available</h3>
                            <p className="text-gray-500 dark:text-slate-400 text-[12px] font-medium">There are currently no reviews available to display.</p>
                        </div>
                    ) : (
                        <div className="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-2xl p-6 shadow-sm">
                            ...
                            <div className="flex justify-between items-center mb-6 pb-5 border-b border-gray-50 dark:border-slate-700">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="text-[15px] font-black text-gray-800 dark:text-white leading-tight">{selectedSource}</h3>
                                    ...
                                    <div key={dist.rating} className="flex flex-col gap-1.5 w-full group cursor-default">
                                        <div className="flex items-center justify-between w-full">
                                            <div className="flex items-center gap-1.5 min-w-[36px]">
                                                <span className="text-[13px] font-bold text-gray-700 dark:text-gray-300 group-hover:text-amber-500 transition-colors">{dist.rating}</span>
                                            ...
                                            <div className="flex items-end flex-col">
                                                <span className="text-[13px] text-gray-800 dark:text-gray-200 font-black">{dist.percentage}%</span>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex justify-between items-center text-[11px] mt-0.5">
                                            <span className="text-gray-400 dark:text-slate-500 font-bold uppercase tracking-wider">{dist.count.toLocaleString()} Reviews</span>
