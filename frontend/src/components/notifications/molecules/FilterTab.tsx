...
const FilterTab: React.FC<FilterTabProps> = ({
  ...
  return (
    <button
      onClick={onClick}
      className={`px-4 py-2 rounded-xl text-[13px] font-bold cursor-pointer transition-all duration-300 border flex items-center gap-2.5 ${
        isActive
    ...
    >
      {label}
      <span
        className={`text-[10px] px-2 py-0.5 rounded-lg font-black tracking-widest transition-all duration-300 ${
          isActive
