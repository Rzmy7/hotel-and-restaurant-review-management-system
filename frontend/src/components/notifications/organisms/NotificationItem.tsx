            ...
            <div className="flex items-start gap-5 p-5">
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3 mb-1.5">
                        <h4 className={`text-sm tracking-tight m-0 truncate transition-colors duration-300 ${read
                    ...
                    <p className={`text-[13px] leading-relaxed transition-colors duration-300 ${read
