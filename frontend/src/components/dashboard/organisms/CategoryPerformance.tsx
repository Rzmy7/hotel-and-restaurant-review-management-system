          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center py-8 gap-3 min-h-[240px]">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400 dark:text-slate-500 mt-1">
                Categories will appear once reviews with category tags are
                collected.
              </p>
            </div>
          </div>
            ...
            >
              <div className="flex items-center justify-between w-full">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <span className="text-sm font-black text-gray-800 dark:text-white block leading-tight">
                      {category.name}
                    </span>
                ...
                <div className="text-right">
                  ...
                  <div className="flex items-center gap-1 justify-end">
                    ...
                    <span
                      className={`text-[10px] font-black uppercase tracking-widest ${getTrendColor(category.trendType)}`}
                    >
                      {category.trend}
                    </span>
                  </div>
