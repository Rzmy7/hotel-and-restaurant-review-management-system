      ...
      <div className="flex gap-10 items-center max-md:flex-col lg:flex-row">
        ...
        <div className="relative w-[180px] h-[180px] shrink-0">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center pointer-events-none">
            <p className="m-0 text-4xl font-black text-gray-900 dark:text-white tracking-tighter">
              {positive.percentage}
              <span className="text-xl">%</span>
            </p>
            <p className="mt-0.5 text-[10px] uppercase font-black text-[#4e80ee] dark:text-blue-400 tracking-widest">
              Positive
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3 flex-1 w-full">
          ...
          >
            ...
            <div className="flex-1">
              <p className="text-[10px] font-bold text-gray-400 dark:text-slate-400 uppercase tracking-wider leading-none mb-1.5">
                Positive
              </p>
            ...
            <div className="text-right">
              <p className="text-lg font-black text-[#4e80ee] dark:text-blue-400">
                {positive.percentage}%
              </p>
            </div>
          </button>
