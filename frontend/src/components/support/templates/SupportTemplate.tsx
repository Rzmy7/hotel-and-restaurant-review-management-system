...
const FAQs = [
  {
    ...
    a: "You can reset your API key from the Settings > Integrations tab. Note that all existing connections will be severed.",
  },
  {
    q: "What is the monthly review limit?",
    a: "Our Standard plan includes up to 5,000 imports per month. Enterprise accounts have unlimted access.",
  },
  {
    q: "Can I connect multiple hotel sources?",
    a: "Yes, you can add up to 50 sources per organization in the current version.",
  },
];
            ...
            <section className="space-y-8">
              ...
              <div className="grid gap-4">
                {FAQs.map((faq, i) => (
                  <div
                    key={i}
                    className="p-6 rounded-3xl bg-white/40 dark:bg-slate-800/40 backdrop-blur-sm border border-gray-100 dark:border-slate-800"
                  >
          ...
          <aside className="space-y-12 order-1 xl:order-2">
            ...
            <div className="p-8 rounded-[40px] bg-gradient-to-br from-slate-900 to-slate-800 text-white relative overflow-hidden shadow-2xl">
              <div className="relative z-10">
                <h4 className="text-2xl font-black uppercase tracking-tighter mb-4 italic">
                  Enterprise SOS
                </h4>
                <p className="text-sm font-medium text-slate-400 leading-relaxed mb-8">
                  For critical infrastructure failure or data breach reports,
                  please use our 24/7 priority line.
                </p>
