...
const contactOptions = [
  ...
  },
  {
    ...
    title: "Live Chat",
    description:
      "Instant assistance for priority issues and technical hurdles.",
  ...
  return (
    <div className="grid gap-4">
      {contactOptions.map((opt) => (
        ...
        >
          <div
            className={`w-14 h-14 rounded-2xl flex items-center justify-center shrink-0 ring-1 ${opt.ring} ${opt.color} shadow-sm transition-transform duration-300 group-hover:scale-110`}
          >
            {opt.icon}
          </div>
