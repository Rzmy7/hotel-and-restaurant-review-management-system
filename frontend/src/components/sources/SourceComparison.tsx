...
import { Card } from "../dashboard/atoms/Card";
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-10 border-b border-gray-50 dark:border-slate-800 pb-8">
        <div>
          <h3 className="m-0 text-sm font-black text-gray-700 dark:text-gray-200 uppercase tracking-widest flex items-center gap-2">
            ...
            <Info
              size={14}
              className="text-gray-300 dark:text-slate-500 cursor-help"
            />
          </h3>
        ...
        <div className="flex items-center gap-4 mt-4 sm:mt-0 bg-gray-50/50 dark:bg-slate-800/50 px-4 py-2.5 rounded-xl border border-gray-100 dark:border-slate-700">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[9px] text-gray-400 dark:text-slate-400 font-black uppercase tracking-widest">
              Positive
            </span>
          </div>
          <div className="flex items-center gap-2">
        ...
        <div className="flex flex-col items-center">
          <div className="w-[180px] h-[180px] shrink-0 relative flex items-center justify-center">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none transition-transform duration-300">
              ...
              <span className="text-[9px] font-bold text-gray-400 dark:text-slate-400 uppercase tracking-[0.2em] mt-2">
                Total
              </span>
            </div>
          </div>
                ...
                >
                  <div className="flex items-end justify-between text-[10px] font-bold pb-1 border-b border-black/5 dark:border-white/5">
                    <div className="flex items-baseline gap-1">
                      ...
                      <span className="text-gray-400 dark:text-slate-400 font-medium tracking-tight">
                        Share
                      </span>
                    </div>
                    {!isCompact && (
                  ...
                  <div className={`${isCompact ? "space-y-2" : "space-y-3"}`}>
                    ...
                    <div
                      className={`${isCompact ? "p-1.5" : "p-2"} bg-white/40 dark:bg-slate-800/40 rounded-lg border border-black/5 dark:border-white/5`}
                    >
                      <div className="flex justify-between items-center mb-1">
                        <span className="text-[8px] font-black text-gray-400 dark:text-slate-400 uppercase tracking-widest">
                          Sentiment
                        </span>
