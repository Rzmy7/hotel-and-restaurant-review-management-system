  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 shadow-sm overflow-hidden">
                          ...
                          switch (statusFilter) {
                            case "Active":
                              return {
                                ...
                                description: "You don't have any active review sources at the moment.",
                                Icon: Play,
                              };
                            case "Paused":
                              return {
                                title: "No paused sources found",
                                description: "There are no review sources paused currently.",
                                Icon: Pause,
                              };
                            case "Error":
                              return {
                                title: "No sources with errors",
                                description: "All your connected review sources are running smoothly!",
                                Icon: AlertCircle,
                              };
                            default:
                              return {
                                title: "No sources found",
                                description: "No review sources match your active search or filter criteria.",
                                Icon: RefreshCw,
                              };
                          }
                        })();
      ...
      <ConfirmationModal
        ...
        title="Remove Source"
        description="Are you sure you want to remove this source? All associated data will be deleted."
        confirmText="Remove"
        cancelText="Cancel"
        variant="danger"
      />
