...
export const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    (
        ...
        const variants = {
            ...
            //primary: "bg-green-600 text-white hover:bg-green-700 shadow-md shadow-green-500/20 hover:shadow-lg hover:shadow-green-500/30 dark:bg-green-600 dark:hover:bg-green-500",
            ...
            outline: "bg-transparent text-gray-700 border-2 border-gray-200 hover:border-gray-300 hover:bg-gray-50 dark:border-slate-700 dark:text-gray-300 dark:hover:bg-slate-700",
