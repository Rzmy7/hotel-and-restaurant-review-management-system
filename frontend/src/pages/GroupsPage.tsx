        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              placeholder="e.g. Regional Operations Team"
      ...
      <header className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-gray-100 dark:border-slate-800 sticky top-0 z-[40] px-4 sm:px-6 lg:px-8 py-5 flex flex-wrap items-center justify-between gap-3 transition-all duration-300">
        <div className="flex flex-col">
          ...
          <p className="mt-0.5 text-[11px] text-gray-400 dark:text-slate-400 font-bold uppercase tracking-wider">
            Manage your organization’s groups and team members
          </p>
        </div>
        <div className="flex items-center gap-3">
          {invites.length > 0 && (
          ...
          {loadingGroups ? (
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl border border-dashed border-gray-200 dark:border-slate-700 shadow-sm p-12 text-center">
              ...
              <p className="text-sm text-gray-400 dark:text-slate-500 mt-1">
                Create a group to start collaborating with team members
              </p>
              <button
                onClick={() => setShowCreateModal(true)}
            ...
            {memberGroups.length === 0 ? (
              <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm p-6">
                <p className="text-sm text-gray-400 dark:text-slate-500">
                  You haven't been assigned to any groups as a team member yet.
                </p>
              </div>
            ) : (
              <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
