...
const LoginPage = () => {
  ...
  const [isTwoFactorStep, setIsTwoFactorStep] = useState(
    searchParams.get("oauth_2fa") === "true",
  );
    ...
    switch (field) {
      case "email":
        return setFieldError(
          "email",
          validateLoginEmail(String(value ?? email)),
        );
      case "password":
        return setFieldError(
          "password",
          validateLoginPassword(String(value ?? password)),
        );
      case "verificationCode":
        return setFieldError(
          "verificationCode",
          validateVerificationCode(String(value ?? otpCode)),
        );
      default:
        return undefined;
    }
  ...
  return (
    ...
    >
      ...
      <form
        onSubmit={isTwoFactorStep ? handleVerifyTwoFactor : handleSubmit}
        className="space-y-5"
      >
        {isTwoFactorStep && (
          <div className="rounded-2xl border border-blue-100 dark:border-blue-900/40 bg-blue-50/80 dark:bg-blue-900/20 p-4 mb-6 animate-in fade-in slide-in-from-top-2">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-black text-blue-900 dark:text-blue-200 uppercase tracking-wide">
