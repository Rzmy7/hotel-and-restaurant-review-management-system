        ...
        return (
            <div className="min-h-full bg-gray-50 dark:bg-slate-900">
                ...
                <div className="flex-1 flex flex-col items-center justify-center p-8 mt-20">
                    <div className="max-w-md w-full bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 p-8 text-center">
                        ...
                        <button
                            className="w-full bg-[#4e80ee] hover:bg-blue-600 text-white px-6 py-2.5 rounded-xl text-[13px] font-black uppercase tracking-widest shadow-lg shadow-blue-100 dark:shadow-none transition-all duration-300 transform hover:-translate-y-0.5 active:scale-95 cursor-pointer border-none"
    ...
    return (
        <div className="min-h-full bg-gray-50 dark:bg-slate-900">
            ...
            <div className="w-full px-8 py-6 flex-1 max-w-[1600px] mx-auto space-y-6">
                ...
                {/* Error Banner */}
                {fetchError && (
                    <div className="flex items-center gap-3 bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-800/50 rounded-xl px-4 py-3 text-sm text-red-700 dark:text-red-400">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 min-[1000px]:grid-cols-4 gap-4">
                    {[
                        ...
                        <div key={m.label} className="flex items-center gap-3.5 p-5 bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl shadow-sm transition-all duration-200 hover:shadow-lg hover:shadow-gray-200/40 dark:hover:shadow-slate-900/40 hover:-translate-y-0.5">
                            <div className={`w-10 h-10 flex items-center justify-center ${m.bg} ${m.fg} rounded-xl`}>{m.icon}</div>
                            <div className="flex-1">
                                <p className="text-[10px] font-bold text-gray-400 dark:text-slate-400 uppercase tracking-wider m-0">{m.label}</p>
                ...
                {insightData && (
                    <div className="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl p-5 shadow-sm">
                        <div className="flex items-center gap-2 mb-4">
                            <div className="w-8 h-8 flex items-center justify-center bg-indigo-50 dark:bg-indigo-900/40 text-indigo-500 dark:text-indigo-400 rounded-lg">
                                <TrendingUp size={15} />
                            </div>
                            <h3 className="m-0 text-[11px] font-black text-gray-500 dark:text-slate-400 uppercase tracking-widest">Period Summary</h3>
                            <span className="text-[10px] text-gray-400 dark:text-slate-400 font-bold uppercase tracking-wider ml-1">vs previous {timeRange}</span>
                        </div>
                            ...
                            {[
                                ...
                                return (
                                    <div key={item.label} className="flex flex-col gap-1 p-3 bg-gray-50 dark:bg-slate-700/40 rounded-lg border border-gray-100 dark:border-slate-700">
                                        <span className="text-[10px] text-gray-400 dark:text-slate-400 font-bold uppercase tracking-wider">{item.label}</span>
                                        <span className="text-base font-bold text-gray-900 dark:text-white">{item.current}</span>
                ...
                <div className="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl p-5 shadow-sm">
                    <div className="flex justify-between items-start mb-1">
                        <h3 className="m-0 text-[11px] font-black text-gray-500 dark:text-slate-400 uppercase tracking-widest">Sentiment Over Time</h3>
                        <div className="flex gap-4">
                            {[
                                ...
                                <div key={l.label} className="flex items-center gap-1.5 text-[10px] font-bold text-gray-400 dark:text-slate-400 uppercase tracking-wider">
                ...
                <div className="grid grid-cols-1 min-[1000px]:grid-cols-2 gap-5">
                    ...
                    {/* Rating Distribution */}
                    <div className="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl p-5 shadow-sm">
                        <h3 className="m-0 text-[11px] font-black text-gray-500 dark:text-slate-400 uppercase tracking-widest mb-5">Rating Distribution</h3>
                    ...
                    <div className="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl p-5 shadow-sm">
                        <h3 className="m-0 text-[11px] font-black text-gray-500 dark:text-slate-400 uppercase tracking-widest mb-5">Category Performance</h3>
                ...
                <div className="grid grid-cols-1 min-[1000px]:grid-cols-2 gap-5">
                    ...
                    <div className="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl p-5 shadow-sm">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="m-0 text-[11px] font-black text-gray-500 dark:text-slate-400 uppercase tracking-widest">Top Positive Keywords</h3>
                        </div>
                    ...
                    <div className="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl p-5 shadow-sm">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="m-0 text-[11px] font-black text-gray-500 dark:text-slate-400 uppercase tracking-widest">Top Negative Keywords</h3>
                        </div>
                ...
                <div className="grid grid-cols-1 min-[1000px]:grid-cols-2 gap-5">
                    ...
                    {/* Response Metrics */}
                    <div className="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl p-5 shadow-sm">
                        <h3 className="m-0 text-[11px] font-black text-gray-500 dark:text-slate-400 uppercase tracking-widest mb-5">Response Metrics</h3>
                        <div className="grid grid-cols-3 gap-4">
                            {[
                                ...
                                <div key={m.label} className="flex flex-col items-center text-center p-4 bg-gray-50 dark:bg-slate-700/50 rounded-xl">
                                    ...
                                    <span className="text-2xl font-bold text-gray-900 dark:text-white">{m.value}</span>
                                    <span className="text-[10px] font-bold text-gray-400 dark:text-slate-400 uppercase tracking-wider mt-1">{m.label}</span>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl p-5 shadow-sm">
                        <div className="flex justify-between items-center mb-4">
                            <h3 className="m-0 text-[11px] font-black text-gray-500 dark:text-slate-400 uppercase tracking-widest">Review Volume</h3>
                ...
                <div className="bg-white dark:bg-slate-800 border border-gray-100 dark:border-slate-700 rounded-xl p-5 shadow-sm">
                    <div className="flex items-center gap-2 mb-5">
                        <div className="w-8 h-8 flex items-center justify-center bg-gradient-to-br from-blue-500 to-violet-500 rounded-lg">
                            <Lightbulb size={16} className="text-white" />
                        </div>
                        <div>
                            <h3 className="m-0 text-[11px] font-black text-gray-500 dark:text-slate-400 uppercase tracking-widest">AI Recommendations</h3>
                            <p className="m-0 text-[10px] text-gray-400 dark:text-slate-400 font-bold uppercase tracking-wider">Actionable insights based on review analysis</p>
                        </div>
                    </div>
