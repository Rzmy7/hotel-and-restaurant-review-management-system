            ...
            <main className="w-full px-8 py-6 flex-1 max-w-[1600px] mx-auto space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 flex flex-col justify-center h-[140px]">
                        ...
                        <h2 className="text-[44px] leading-none font-bold text-[#3b82f6]">#2</h2>
                    </div>
                    ...
                    <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 flex flex-col justify-center h-[140px]">
                        ...
                        <h2 className="text-[44px] leading-none font-bold text-gray-900">5</h2>
                    </div>
                    ...
                    <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6 flex flex-col justify-center h-[140px]">
                        ...
                        <div className="mt-1">
                            <h3 className="text-[20px] font-bold text-gray-900 mb-2">Luxury Grand Resort</h3>
                            <div className="flex items-center gap-1">
                                <span className="font-bold text-gray-700 text-sm">4.7</span>
                ...
                <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden mt-8">
                    ...
                    <div className="px-6 py-5 border-b border-gray-100 flex items-center justify-between bg-white">
                        ...
                        <button className="flex items-center justify-between gap-3 px-4 py-2 bg-white border border-gray-200 rounded-lg text-sm text-gray-700 hover:bg-gray-50 transition-colors shadow-sm">
                            Average Rating
                        </button>
                    </div>
