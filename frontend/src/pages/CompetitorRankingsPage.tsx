...
const CompetitorRankingsPage = () => {
  ...
  const currentSortLabel =
    SORT_OPTIONS.find((o) => o.key === sortBy)?.label ?? "Average Rating";
      ...
      <main className="w-full px-8 py-6 flex-1 max-w-[1600px] mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm p-6 flex flex-col justify-center h-[140px]">
            <p className="text-xs font-semibold text-gray-400 dark:text-slate-400 uppercase tracking-wider mb-2">
              Your Current Rank
            </p>
            <h2 className="text-[44px] leading-none font-bold text-[#3b82f6] dark:text-blue-400">
              #{yourRank}
            </h2>
          </div>
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm p-6 flex flex-col justify-center h-[140px]">
            ...
            <h2 className="text-[44px] leading-none font-bold text-gray-900 dark:text-white">
              {rankings.length}
            </h2>
          </div>
          <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm p-6 flex flex-col justify-center h-[140px]">
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl border border-gray-100 dark:border-slate-700 shadow-sm overflow-hidden mt-8">
          <div className="px-6 py-5 border-b border-gray-100 dark:border-slate-700 flex items-center justify-between bg-white dark:bg-slate-800">
            ...
            <span className="text-xs font-semibold text-gray-400 dark:text-slate-400 uppercase tracking-wider">
              Sorted by:{" "}
              <span className="text-blue-500">{currentSortLabel}</span>
            </span>
          </div>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-white dark:bg-slate-800 border-b border-gray-100 dark:border-slate-700">
                  <th className="px-6 py-4 text-[11px] font-bold text-gray-400 dark:text-slate-400 uppercase tracking-widest w-[10%]">
                    Rank
                  </th>
                  <th className="px-6 py-4 text-[11px] font-bold text-gray-400 dark:text-slate-400 uppercase tracking-widest w-[30%]">
                    Organization Name
                  </th>
                  <th className="px-6 py-4 text-[11px] font-bold text-gray-400 dark:text-slate-400 uppercase tracking-widest w-[20%]">
                    <div
                      onClick={() => setSortBy("rating")}
                      className={`flex items-center gap-1.5 cursor-pointer transition-colors ${sortBy === "rating" ? "text-blue-500" : "hover:text-gray-600 dark:hover:text-gray-200"}`}
                    >
                  ...
                  <th className="px-6 py-4 text-[11px] font-bold text-gray-400 dark:text-slate-400 uppercase tracking-widest w-[20%]">
                    <div
                      ...
                      className={`flex items-center gap-1.5 cursor-pointer transition-colors ${sortBy === "sentiment" ? "text-blue-500" : "hover:text-gray-600 dark:hover:text-gray-200"}`}
                    >
                  ...
                  <th className="px-6 py-4 text-[11px] font-bold text-gray-400 dark:text-slate-400 uppercase tracking-widest w-[20%]">
                    <div
                      ...
                      className={`flex items-center gap-1.5 cursor-pointer transition-colors ${sortBy === "reviews" ? "text-blue-500" : "hover:text-gray-600 dark:hover:text-gray-200"}`}
                    >
                  ...
                  sorted.map((competitor) => (
                    ...
                    >
                      <td className="px-6 py-[22px]">
                        <span className="font-medium text-gray-500 dark:text-slate-400 text-[14px]">
                          #{competitor.rank}
                        </span>
                      </td>
                      <td className="px-6 py-[22px]">
                      ...
                      <td className="px-6 py-[22px]">
                        <span className="font-medium text-gray-700 dark:text-gray-300 text-[14px]">
