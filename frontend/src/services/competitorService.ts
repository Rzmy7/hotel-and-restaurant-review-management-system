...
export async function addCompetitor(
  ...
  return apiClient.post<{ message: string; competitor: Competitor }>(
    `/competitors/?organization_id=${organizationId}`,
    params,
  );
}
...
export async function fetchSuggestedCompetitors(
  organizationId: string,
...
export async function addCompetitorFromOrganization(
  organizationId: string,
  target_organization_id: string,
): Promise<{ message: string; competitor: Competitor }> {
  return apiClient.post<{ message: string; competitor: Competitor }>(
    `/competitors/from-organization?organization_id=${organizationId}`,
...
export async function trackCompetitor(
  ...
  return apiClient.post<{ message: string; competitor: Competitor }>(
    `/competitors/track?organization_id=${organizationId}`,
    { competitorId },
  );
}
...
export async function untrackCompetitor(
  ...
  return apiClient.post<{ message: string }>(
    `/competitors/untrack?organization_id=${organizationId}`,
    { competitorId },
  );
}
...
export async function deleteCompetitor(
  ...
  return apiClient.delete<{ message: string }>(
    `/competitors/${competitorId}?organization_id=${organizationId}`,
  );
}
...
export async function editCompetitor(
  organizationId: string,
  competitorId: string,
  params: { name: string; location_url: string },
): Promise<{ message: string; competitor: Competitor }> {
  return apiClient.put<{ message: string; competitor: Competitor }>(
    `/competitors/${competitorId}?organization_id=${organizationId}`,
    params,
  );
}
...
export async function scrapeCompetitor(
  competitorId: string,
  headless = true,
): Promise<{ message: string; competitorId: string }> {
  return apiClient.post<{ message: string; competitorId: string }>(
    `/competitors/${competitorId}/scrape`,
    { headless },
  );
}
