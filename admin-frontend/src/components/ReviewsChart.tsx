        ...
        return (
            <div className="relative overflow-hidden rounded-xl border border-gray-200/80 dark:border-slate-700 bg-gradient-to-br from-white via-slate-50 to-blue-50/60 dark:from-slate-800 dark:via-slate-800 dark:to-slate-800 p-6 shadow-sm flex flex-col h-full min-h-[350px] transition-colors duration-200">
                ...
                <div className="relative flex-1 flex flex-col">
                    <div className="mb-5">
                        <h3 className="text-base font-semibold text-slate-900 dark:text-white">Reviews by Platform</h3>
                        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Total reviews collected from configured sources</p>
                    </div>
                                    ...
                                    <div className="flex items-center justify-between gap-3">
                                        <div className="flex min-w-0 items-center gap-4">
                                            ...
                                            <div className="min-w-0">
                                                <div className="truncate text-base font-semibold text-slate-800 dark:text-white">{item.label}</div>
