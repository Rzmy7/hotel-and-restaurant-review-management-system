    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 p-6 flex flex-col h-full">
                ...
                <div>
                    <div className="text-gray-500 dark:text-slate-400 text-sm mb-2">All Active Users</div>
                    <div className="text-3xl font-bold text-gray-900 dark:text-white">{allActiveUsers}</div>
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 p-6 flex flex-col h-full">
                ...
                <div>
                    <div className="text-gray-500 dark:text-slate-400 text-sm mb-2">Today Active Users</div>
                    <div className="text-3xl font-bold text-gray-900 dark:text-white">{todayActiveUsers}</div>
                    <div className="flex items-center gap-1 mt-2 text-xs text-gray-400 dark:text-slate-500">
                        <Activity size={13} />
            ...
            <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-gray-100 dark:border-slate-700 p-6 flex flex-col h-full">
                ...
                <div>
                    <div className="text-gray-500 dark:text-slate-400 text-sm mb-2">Today Registered</div>
                    <div className="text-3xl font-bold text-gray-900 dark:text-white">{todayRegistered}</div>
                    <div className="flex items-center gap-1 mt-2 text-xs text-gray-400 dark:text-slate-500">
