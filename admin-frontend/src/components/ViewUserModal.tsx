      ...
      <div className="relative bg-white dark:bg-slate-800 rounded-xl shadow-xl w-full max-w-lg mx-4">
        ...
        <div className="p-6">
          ...
          <div className="flex flex-col items-center mb-6">
            <div
              className={`w-20 h-20 rounded-full flex items-center justify-center text-2xl font-medium ${getAvatarColor()} mb-3`}
            >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      {user.organizations.map((org, idx) => (
                        <span
                          key={idx}
                          className="inline-flex px-2 py-1 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-400 text-xs font-medium rounded"
                        >
                          {org}
                        </span>
                      ))}
                ...
                <div className="flex-1">
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {user.groups.map((group, idx) => (
                      <span
                        key={idx}
                        className="inline-flex px-2 py-1 bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-400 text-xs font-medium rounded"
                      >
                        {group}
                      </span>
                    ))}
