      ...
      <tr className="border-b border-gray-50 dark:border-slate-700 hover:bg-blue-50/50 dark:hover:bg-slate-800/50 transition-all duration-200 group">
        <td className="px-6 py-4">
          <div className="flex items-center gap-3">
            <div
              className={`w-10 h-10 rounded-xl flex items-center justify-center text-sm font-semibold shadow-sm group-hover:scale-110 transition-transform duration-300 ${getAvatarColor()}`}
            >
        ...
        <td className="px-6 py-4 text-gray-700 dark:text-slate-200 font-semibold">
          {user.role}
        </td>
        <td className="px-6 py-4">
          <span
