...
export const ContentEditor: React.FC<ContentEditorProps> = ({ subject, body, onSubjectChange, onBodyChange }) => {
    return (
        <div className="space-y-4">
            {/* Subject */}
            <div>
                <label className="block text-sm font-semibold text-gray-900 dark:text-white mb-2">Subject Line *</label>
                <input
                    type="text"
                    value={subject}
            ...
            {/* Body */}
            <div>
                <label className="block text-sm font-semibold text-gray-900 dark:text-white mb-2">Message Body *</label>
                <textarea
                    value={body}
