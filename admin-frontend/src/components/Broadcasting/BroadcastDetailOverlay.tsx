            ...
            <div className="relative bg-white dark:bg-slate-800 w-full sm:w-[420px] h-full sm:h-auto sm:max-h-[90vh] sm:rounded-l-2xl shadow-2xl flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto px-5 py-5 space-y-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-700 dark:text-slate-300 leading-relaxed whitespace-pre-wrap">{record.body}</p>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-2 border-t border-gray-100 dark:border-slate-700">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-800 dark:text-slate-200 font-medium">{record.audienceLabel}</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-800 dark:text-slate-200">{record.sentBy}</p>
                        </div>
                        <div className="col-span-2">
                            <p className="text-xs text-gray-400 dark:text-slate-500 mb-0.5">Sent at</p>
                            <p className="text-sm text-gray-800 dark:text-slate-200">{formatDateTime(record.sentAt, timezone)}</p>
                        </div>
                    </div>
                </div>
            </div>
