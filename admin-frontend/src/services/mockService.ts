    ...
    setTimeout(() => {
      resolve([
        ...
        },
        {
          ...
          plan: "Basic",
          avatarColor: "#fed7aa",
          organizations: ["Global Solutions"],
          groups: ["Developers", "Mobile Team"],
        },
        {
          id: "4",
          name: "David Kim",
        ...
        },
        {
          ...
          avatarColor: "#fca5a5",
          organizations: ["Acme Corp"],
          groups: ["Developers", "Frontend Team", "QA Team"],
        },
      ]);
    }, 600);
  });
      ...
      resolve([
        {
          ...
          description:
            "Enable semantic search across reviews and content using vector embeddings",
          status: "Enabled",
        },
        {
          id: "3",
          name: "Custom Report Generation",
          key: "custom_report_generation",
          description:
            "Allow users to create and export customized reports with selected metrics",
          status: "Disabled",
        },
      ]);
    }, 600);
      ...
      resolve([
        {
          ...
          message:
            "TripAdvisor scraper failed for Hotel Grand Plaza - Connection timeout",
        ...
        },
        {
          ...
          message:
            "Intermittent connection issues detected with replica database",
    ...
    setTimeout(() => {
      resolve([
        ...
        },
        {
          ...
          description:
            "Booking.com scrape completed - 156 new reviews collected",
...
export const fetchScrapingStats = (): Promise<
  import("../types").ScrapingStats
> => {
  return new Promise((resolve) => {
    setTimeout(() => {
      resolve({
...
export const fetchScrapingPlatforms = (): Promise<
  import("../types").ScrapingPlatform[]
> => {
  return new Promise((resolve) => {
    setTimeout(() => {
      resolve([
...
export const fetchScrapingJobs = (): Promise<
  import("../types").ScrapingJob[]
> => {
  return new Promise((resolve) => {
    setTimeout(() => {
      resolve([
        {
          ...
          organization: "Grand Hotel Budapest",
          status: "Running",
        ...
        },
        {
          ...
          platformIcon: "T",
          platformColor: "#00AF87",
          organization: "Seaside Resort & Spa",
          status: "Completed",
        ...
        },
        {
          ...
          platform: "Agoda",
          platformIcon: "Ag",
          platformColor: "#5E4B8B",
          organization: "Mountain View Lodge",
          status: "Failed",
          startTime: "Yesterday, 11:30 PM",
          duration: "0s",
          reviews: 0,
        },
        {
          ...
          platformIcon: "B",
          platformColor: "#003580",
          organization: "City Center Boutique",
          status: "Completed",
          startTime: "Yesterday, 08:00 PM",
          duration: "8m 33s",
          reviews: 45,
        },
        {
          ...
          platformIcon: "T",
          platformColor: "#00AF87",
          organization: "Blue Lagoon Hotel",
          status: "Completed",
          startTime: "Yesterday, 06:15 PM",
          duration: "5m 01s",
          reviews: 12,
        },
      ]);
    ...
    setTimeout(() => {
      ...
      import("lucide-react").then(({ Server, Database, Search, Globe }) => {
        ...
        const randomVariation = (base: number, range: number) =>
          Math.min(
            100,
            Math.max(0, base + (Math.random() * range * 2 - range)),
          );
