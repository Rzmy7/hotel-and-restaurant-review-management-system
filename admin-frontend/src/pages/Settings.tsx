...
export const Settings: React.FC = () => {
  ...
  const [adminProfileSaveState, setAdminProfileSaveState] = useState<
    "idle" | "saving" | "saved" | "error"
  >("idle");
  ...
  const [passwordModalSaveState, setPasswordModalSaveState] = useState<
    "idle" | "saving" | "saved" | "error"
  >("idle");
  ...
  const timezoneOptionExists = TIMEZONE_OPTIONS.some(
    (option) => option.value === settings.timezone,
  );
  const timezoneOptions = timezoneOptionExists
    ? TIMEZONE_OPTIONS
    : [
        { value: settings.timezone, label: `Custom - ${settings.timezone}` },
        ...TIMEZONE_OPTIONS,
      ];
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(event) =>
                    handleGeneralSettingChange("timezone", event.target.value)
                  }
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(event) =>
                    handleGeneralSettingChange("currency", event.target.value)
                  }
                  className="w-full px-3 py-2 border border-gray-200 dark:border-slate-600 dark:bg-slate-700 dark:text-white rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
              </div>
        ...
        <div className="space-y-4">
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 p-4">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-500 dark:text-slate-400">
                Configure operational alerts for administrators
              </p>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-slate-400">
                    Get alerted when API usage is close to configured limits
                  </p>
                </div>
                <ToggleSwitch
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-slate-400">
                    Notify when server resource usage stays above safe
                    thresholds
                  </p>
                </div>
                <ToggleSwitch
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-slate-400">
                    Alert when backend services or databases lose connectivity
                  </p>
                </div>
                <ToggleSwitch
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-slate-400">
                    Receive notifications when scraping jobs fail or repeatedly
                    error
                  </p>
                </div>
                <ToggleSwitch
        ...
        <div className="space-y-4">
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 p-4">
            <div className="mb-4">
              ...
              <p className="text-sm text-gray-500 dark:text-slate-400">
                Update administrator identity and password
              </p>
            </div>
