...
export const Organizations: React.FC = () => {
  ...
  const handleAddSource = () => {
    ...
    setSourceUrls((prev) => ({
      ...prev,
      [src.source_id]: addSourceUrl.trim(),
    }));
    setAddSourceId("");
    setAddSourceUrl("");
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-sm p-6 space-y-4">
            ...
            <p className="text-sm text-gray-600 dark:text-slate-300">
              ...
              ? This will also remove all linked source URLs and cannot be
              undone.
            </p>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-lg flex flex-col max-h-[90vh]">
            <div className="flex items-center justify-between px-6 pt-5 pb-4 border-b border-gray-100 dark:border-slate-700">
              ...
              <button
                ...
                className="p-1.5 text-gray-400 dark:text-slate-400 hover:text-gray-600 dark:hover:text-slate-300 dark:text-slate-400 dark:hover:text-slate-200 rounded-lg"
              >
                <X size={18} />
              </button>
            </div>
                ...
                {editLoading ? (
                  ...
                  <div className="space-y-2">
                    ...
                    {editSources.map((src) => (
                      ...
                      >
                        <span className="w-28 text-xs font-medium text-gray-600 dark:text-slate-300 truncate shrink-0">
                          {src.platform_name}
                        </span>
                        <input
                          type="url"
